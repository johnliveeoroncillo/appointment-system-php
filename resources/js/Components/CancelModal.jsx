...
function CancelModal({ isOpen, selectedAppointmentId, onClose, toast }) {
    // function deleteAppointment(id) {
    //     router.update(`/appointment/${id}`, {
    //         onSuccess: () => {
    //             onClose();
    ...
    //     });
    // }
    const clickToCancel = (id) => {
        router.patch(route("appointment.updateStatus", { id }));
    };
            ...
            <Modal show={isOpen} onClose={onClose} maxWidth="md">
                <div className="p-4 flex items-center justify-center flex-col">
                    ...
                    <p className="text-sm text-gray-500">
                        You will be able to see the canceled appointment in
                        history page.
                    </p>
                </div>
                ...
                <div className="p-4 flex w-full justify-center space-x-5 font-semibold">
                    {selectedAppointmentId && (
                        <button
                            ...
                            onClick={() => clickToCancel(selectedAppointmentId)}
                        >
                            Confirm
                        </button>
                    )}
