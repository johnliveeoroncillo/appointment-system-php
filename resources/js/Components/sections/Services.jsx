...
const Services = () => {
    return (
        <>
            <div
                className="px-5 py-10 bg-white | md:px-14"
                id="services"
                data-aos="fade-up"
            >
                ...
                <div className="md:flex md:space-x-10">
                    <ServiceCard
                        ...
                        icon={
                            <ClipboardDocumentCheckIcon className="text-secondaryColor  w-[70px] h-auto " />
                        }
                    ...
                    <ServiceCard
                        ...
                        icon={
                            <BuildingOfficeIcon className="text-secondaryColor  w-[70px] h-auto " />
                        }
                        title="Confinement"
                    ...
                    <ServiceCard
                        ...
                        icon={
                            <BuildingOffice2Icon className="text-secondaryColor  w-[70px] h-auto " />
                        }
                    ...
                    />
                    <ServiceCard
                        image="images/homeMedication.png"
                        altText="image for home medication"
                        icon={
                            <HomeIcon className="text-secondaryColor  w-[70px] h-auto " />
                        }
